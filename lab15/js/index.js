document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', (event) => {
        ...
        if (isEditing && currentEditedElement) {
            // === ВИКОНАНЕ ЗАВДАННЯ ===
            // Оновлюємо DOM-елементи всередині редагованої картки новими даними
            ...
            // Перевіряємо, чи введено дедлайн, інакше ставимо "Без дати"
            const deadlineElement = currentEditedElement.querySelector('.task-card__deadline');
            deadlineElement.textContent = taskData.deadline ? taskData.deadline : 'Без дати';
            // =========================
